...
DIR_DAY_N='lab_04'                      # folder name
FILENAME_RTL_TOP='controller'           # file name rtl top module
FILENAME_TB_TOP='tb_controller'         # file name tb top
FILENAME_VVP='controller'               # file name output vvp
FILENAME_SYNTH='lab_04_synth'           # file name yosys sim script
FILENAME_NETLIST='netlist_controller'   # file name yosys generated netlist
