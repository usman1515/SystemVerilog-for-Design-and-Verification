...
DIR_DAY_N='lab_03'                     # folder name
FILENAME_RTL_TOP='counter'             # file name rtl top module
FILENAME_TB_TOP='tb_counter'           # file name tb top
FILENAME_VVP='counter'                 # file name output vvp
FILENAME_SYNTH='lab_03_synth'          # file name yosys sim script
FILENAME_NETLIST='netlist_counter'     # file name yosys generated netlist
