...
DIR_DAY_N='lab_02'                      # folder name
FILENAME_RTL_TOP='multiplexor'          # file name rtl top module
FILENAME_TB_TOP='tb_multiplexor'        # file name tb top
FILENAME_VVP='multiplexor'              # file name output vvp
FILENAME_SYNTH='lab_02_synth'           # file name yosys sim script
FILENAME_NETLIST='netlist_multiplexor'  # file name yosys generated netlist
